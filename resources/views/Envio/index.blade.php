...
@endsection
  <section class="container-fluid pt-4">
    <div class="row">
      <div id="mostrar_envio" class="col-lg col-sm col-md">
        ...
        <div class="card ">
            ...
            <div class="container-fluid table-responsive">
              <table id="Envios" class="table table-bordered table-hover table-striped dt-responsive display nowrap" cellspacing="0"
                width="100%">
            ...
            $('#Envios').DataTable({
              ...
              "language":{
               ...
               "columns":[
                 ...
                 {data: 'precio_envio', name: 'e.precio_envio'},
