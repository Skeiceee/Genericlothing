...
<section class="container-fluid mt-4 pl-4">
  ...
  <div class="row mx-auto pl-4">
    <div class="col-lg-3 col-sm-12 col-md-3">
      ...
      <form class="form-group" action="/guest/filtro" method="get">
        @csrf
      <div class="card">
            ...
            <div class="mr-4 mb-4" style="width: 18rem;">
              @php
                ...
                while((($file_name = readdir($dir_handle)) !== false) && ($sw !=  1)){
                  ...
                  if( $ext === 'png' || $ext === 'jpg' ) {
                    echo('<a href="/guest/show/'.$Producto->cod_producto.'"'.$Producto->nom_producto.'"><img class="d-block w-100" src="/img/'.$Producto->nom_producto.'/'.$file_name.'"></a>');
                    $sw = 1;
                  }
